...
| File | Contents |
|---|---|
| [01-fundamentals.md](./01-fundamentals.md) | Design framework, scalability, CAP theorem, consistency models, rate limiting, estimation |
| [02-distributed-systems.md](./02-distributed-systems.md) | Replication, sharding, consensus (Raft), distributed transactions, Saga, Kafka, idempotency, observability |
